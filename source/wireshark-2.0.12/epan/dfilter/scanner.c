...
YY_BUFFER_STATE df__scan_bytes (yyconst char *bytes,yy_size_t len  );
...
void df_set_in  (FILE * _in_str  );

FILE *df_get_out (void );

void df_set_out  (FILE * _out_str  );

yy_size_t df_get_leng (void );

char *df_get_text (void );

int df_get_lineno (void );

void df_set_lineno (int _line_number  );
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE df__scan_bytes  (yyconst char * yybytes, yy_size_t  _yybytes_len )
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
...
void df_set_debug (int  _bdebug )
{
        df__flex_debug = _bdebug ;
}
