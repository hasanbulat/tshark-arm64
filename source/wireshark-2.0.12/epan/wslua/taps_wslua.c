...
static void wslua_http_to_table(lua_State* L, const void* p) { const http_info_value_t* v _U_; v = (const http_info_value_t*)p; lua_newtable(L);
	...
	lua_pushstring(L,"request_uri"); lua_pushstring(L,(const char*)v->request_uri); lua_settable(L,-3);
...
static void wslua_bacapp_to_table(lua_State* L, const void* p) { const bacapp_info_value_t* v _U_; v = (const bacapp_info_value_t*)p; lua_newtable(L);
	lua_pushstring(L,"instance_ident"); lua_pushstring(L,(const char*)v->instance_ident); lua_settable(L,-3);
	lua_pushstring(L,"invoke_id"); lua_pushstring(L,(const char*)v->invoke_id); lua_settable(L,-3);
	lua_pushstring(L,"object_ident"); lua_pushstring(L,(const char*)v->object_ident); lua_settable(L,-3);
	lua_pushstring(L,"service_type"); lua_pushstring(L,(const char*)v->service_type); lua_settable(L,-3);
}
...
static void wslua_actrace_to_table(lua_State* L, const void* p) { const actrace_info_t* v _U_; v = (const actrace_info_t*)p; lua_newtable(L);
	...
	lua_pushstring(L,"cas_frame_label"); lua_pushstring(L,(const char*)v->cas_frame_label); lua_settable(L,-3);
